...
<div class="row">
  ...
  <div class="col-lg-8 align-items-stretch">
    <!-- --------- START USER FORM ---------------- -->
    <form id="create_user_form" method="post" action="<?=ROOT?>course/save_create">
      <div class="card">
        <div class="card-body">
		...
		<div class="row">
            <div class="col-sm-12">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="coursename" id="coursename" placeholder="Course Name Here" <?=getValue('coursename','text') ?>/>
              </div>
            </div>
        </div>
		<div class="row">
            <div class="col-sm-12 col-md-6">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="courseshort" id="courseshort" placeholder="Course Name Here" <?=getValue('courseshort','text') ?>/>
              </div>
            </div>
			<div class="col-sm-12 col-md-6">
              <div class="mb-3">
                <label for="inputlname2" class="control-label col-form-label">Course Code</label>
                <input type="text" class="form-control" name="coursecode" id="coursecode" placeholder="Course Code Here" <?=getValue('coursecode','text') ?>/>
              </div>
            </div>
        </div>
          <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="coursenumber" id="coursenumber" placeholder="Course Code Here" <?=getValue('coursenumber','text') ?>/>
              </div>
            </div>
            <div class="col-sm-12 col-md-6">
              <div class="mb-3">
                ...
                <select name="coursecategory" class="form-select"> 
                  <?php foreach($data['course_categories'] as $row): ?> 
                    <option value="<?= $row->id?>" <?php if(getValue('coursecategory','select') == $row->id): ?> selected="selected" <?php endif ?> > <?= $row->name?> </option> 
                  <?php endforeach; ?> 
                </select>
              </div>
            </div>
        ...
        <div class="p-3 border-top">
          <div class="action-form">
            <div class="mb-3 mb-0 text-end">
              ...
              <a href="<?=ROOT?>course" class="btn btn-dark rounded-pill px-4 waves-effect waves-light"> Cancel </a>
            </div>
          </div>
        </div>
      </div>
