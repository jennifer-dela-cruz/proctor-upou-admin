          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
              <a class="text-muted text-decoration-none" href="
								<?=ROOT?>maintenance/user">Course Category</a>
            </li>
...
<div class="row">
  ...
  <div class="col-lg-8 align-items-stretch">
    <!-- --------- START USER FORM ---------------- -->
    <form id="edit_user_form" method="post" action="<?=ROOT?>maintenance/course_categories/save_edit/<?=$data['course_category_data'][0]->id?>">
      <div class="card">
        <div class="card-body">
		  ...
		  <div class="row">
            <div class="col-sm-12 col-md-12">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="name" id="name" placeholder="Enter Name Here" value="<?=$data['course_category_data'][0]->name?>" />
              </div>
            </div>
          </div>
		  <div class="row">
            <div class="col-sm-12 col-md-12">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="description" id="description" placeholder="Enter Description Here" value="<?=$data['course_category_data'][0]->description?>" />
              </div>
            </div>
          </div>
        </div>
