...
<div class="row">
  ...
  <div class="col-lg-8 align-items-stretch">
    <!-- --------- START USER FORM ---------------- -->
    <form id="create_user_form" method="post"  action="<?=ROOT?>maintenance/user/save_create">
      <div class="card">
        <div class="card-body">
		...
		<div class="row">
            <div class="col-sm-12 col-md-6">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="inputfname" id="inputfname" placeholder="First Name Here" <?=getValue('inputfname','text') ?>/>
              </div>
            </div>
            <div class="col-sm-12 col-md-6">
              <div class="mb-3">
                <label for="inputlname2" class="control-label col-form-label">Last Name</label>
                <input type="text" class="form-control" name="inputlname" id="inputlname" placeholder="Last Name Here" <?=getValue('inputlname','text') ?>/>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-12 col-md-6">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="uname" id="uname" placeholder="Username Here" <?=getValue('uname','text') ?>/>
              </div>
            </div>
            <div class="col-sm-12 col-md-6">
              <div class="mb-3">
                ...
                <select name="roleselect" class="form-select"> 
                  <?php foreach($data['user_roles'] as $row): ?> 
                    <option value="<?= $row->id?>" <?php if(getValue('roleselect','select') == $row->id): ?> selected="selected" <?php endif ?> > <?= $row->shortname?> </option> 
                  <?php endforeach; ?> 
                </select>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-sm-12 col-md-6">
              <div class="mb-3">
                ...
                <input type="password" class="form-control" name="password" id="password" placeholder="Password Here" <?=getValue('password','text') ?> />
              </div>
            </div>
            <div class="col-sm-12 col-md-6">
              <div class="mb-3">
          ...
          <div class="row">
            <div class="col-sm-12 col-md-6">
              <div class="mb-3">
                ...
                <input type="email" class="form-control" name="email1" id="email1" placeholder="Email Here" <?=getValue('email1','text') ?>/>
              </div>
            </div>
            <div class="col-sm-12 col-md-6">
              <div class="mb-3">
                <label for="cono" class="control-label col-form-label">Contact No</label>
                <input type="text" class="form-control" name="cono" id="cono" placeholder="Contact No Here" <?=getValue('cono','text') ?> />
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-8">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="address1" id="address1" placeholder="Address Here" <?=getValue('address1','text') ?> />
              </div>
            </div>
            <div class="col-sm-4">
              <div class="mb-3">
                <label for="city" class="control-label col-form-label">City</label>
                <input type="text" class="form-control" name="city" id="city" placeholder="City Here" <?=getValue('city','text') ?>/>
              </div>
            </div>
          </div>
        </div>
